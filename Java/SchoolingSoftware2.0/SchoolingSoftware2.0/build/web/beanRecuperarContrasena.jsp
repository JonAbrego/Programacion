    ...
    <body>
        <div id="agrupar">
            ...
            <section id="principal">
                <h1>Correo Enviado!</h1><br>
                <a id="exito">Revisa tu bandeja de entrada para recuperar tu usuario y contraseña.</a>
                <jsp:useBean id="beanRecuperar" class="pkgModelo.RecuperarContrasena">
                <jsp:setProperty name="beanRecuperar" property="correo"/>
                <%
                    beanRecuperar.enviarCorreo();
                %>
                </jsp:useBean>
            </section>
            <footer id="pie">
