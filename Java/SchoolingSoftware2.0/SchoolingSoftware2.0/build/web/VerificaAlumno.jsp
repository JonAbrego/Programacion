    ...
    <body>
        <div id="agrupar">
            ...
            <section id="principal">
                <form name="formProfesor" id="formProfesor" action="AdministrarDatosAlumno.jsp" method="post" onsubmit="return validar(this)">
                <table name="formInicio" id="formInicio">
                    <tr>
                        <td></td><td><input type="hidden" name="pass" maxlength="10" value="<jsp:getProperty name="beanIniciarAlumno" property="pass"></jsp:getProperty>"/></td>
                    </tr>
                    <tr>
                        <td>Escribe tu Contraseña: </td><td><input type="password" name="cPass" maxlength="10" autofocus required/></td>
                    </tr>
                    <tr>
