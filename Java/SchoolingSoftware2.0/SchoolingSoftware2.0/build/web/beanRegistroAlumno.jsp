        ...
        <div id="agrupar">
            ...
            <nav id="menu">
                <ul>
                    ...
                    <li class="nivel1"><a href="IniciarSesionAlumno.jsp" class="nivel1">Iniciar Sesion</a></li>
                </ul>
            </nav>
            <section id="principal">
                <jsp:useBean id="beanIAlumno" class="pkgModelo.InsercionAlumno">
                <jsp:setProperty name="beanIAlumno" property="*"/>
                <%
                    if (beanIAlumno.insertar() == false){
                        out.print("<h1>¡Felicidades, te has registrado como alumno!</h1>\n");
                        ...
                        out.print("<tr><td>Teléfono: </td><td>" + request.getParameter("telefono") + "</td></tr>\n");
                        out.print("</table>\n");
                    } else {
