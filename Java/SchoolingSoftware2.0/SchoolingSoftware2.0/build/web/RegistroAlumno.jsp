    ...
    <body>
        <div id="agrupar">
            ...
            <section id="principal">
                ...
                <form name="formAlumno" id="formAlumno" action="beanRegistroAlumno.jsp" method="post" onsubmit="return validar(this)">
                    <table name="formRegistro" id="formRegistro">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="telefono" name="telefono" placeholder="Escribe tu telefono" pattern="\d{10}" title="Escribe los 10 números de tu teléfono, solo números" min="10" maxlength="10" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="password" id="cPass" name="cPass" placeholder="Confirma tu contraseña" maxlength="10"></td>
                        </tr>
                        <tr>
