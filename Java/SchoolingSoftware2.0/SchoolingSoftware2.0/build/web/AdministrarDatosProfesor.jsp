            ...
            <section id="principal">
                ...
                <table name="formRegistro" id="formRegistro">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="nombres" name="nombres" value="<jsp:getProperty name="beanIniciarProfesor" property="nombres"></jsp:getProperty>" pattern="[A-Z]{1}[a-z]{2,}(\s{1}[A-Z]{1}[a-z]{2,})*" title="Primera letra en mayúscula, las demás minúsculas, sólo letras" required autofocus></td>
                    </tr>
                    <tr>
                        <td><label for="aPat">Apellido Paterno: </label></td>
                        <td><input type="text" id="aPat" name="aPat" value="<jsp:getProperty name="beanIniciarProfesor" property="aPat"></jsp:getProperty>" pattern="[A-Z]{1}[a-z]{1,}" title="Primera letra en mayúscula, las demás minúsculas, sólo letras" required></td>
                    </tr>
                    <tr>
                        <td><label for="aMat">Apellido Materno: </label></td>
                        <td><input type="mail" id="aMat" name="aMat" value="<jsp:getProperty name="beanIniciarProfesor" property="aMat"></jsp:getProperty>" pattern="[A-Z]{1}[a-z]{1,}" title="Primera letra en mayúscula, las demás minúsculas, sólo letras"required></td>
                    </tr>
                    <tr>
