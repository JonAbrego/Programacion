    ...
    <body>
        <div id="agrupar">
            ...
            <section id="principal">
                <h1>Se ha asignado la calificacion</h1>
                <jsp:useBean id="beanCalificar" class="pkgModelo.EvaluarAlumno">
                    <jsp:setProperty name="beanCalificar" property="*"/>
                    <%
                    beanCalificar.calificar();
                    beanCalificar.enviarCorreo();
                    %>
                </jsp:useBean>
            </section>
            <footer id="pie">
